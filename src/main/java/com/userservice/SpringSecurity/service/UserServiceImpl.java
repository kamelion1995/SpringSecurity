...
import com.userservice.SpringSecurity.Repo.RoleRepo;
import com.userservice.SpringSecurity.Repo.UserRepo;
...
public class UserServiceImpl implements UserService, UserDetailsService {
    ...
    public Role saveRole(Role role) {
        log.info("saving new  role {} to the databas", role.getName());
